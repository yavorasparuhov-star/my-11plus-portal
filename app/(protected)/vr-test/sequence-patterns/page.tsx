...
export default function VRSequencePatternsPage() {
  ...
  if (loading) {
    return <p style={styles.message}>Loading sequence & patterns tests...</p>
  }
        ...
        <div style={styles.grid}>
          {tests.map((test) => (
            <div
              ...
              onClick={() => router.push(`/vr-test/sequence-patterns/${test.id}`)}
              onMouseEnter={(e) => {
            ...
            >
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation()
                  router.push(`/vr-test/sequence-patterns/${test.id}`)
                }}
                onMouseEnter={(e) => {
