// app/(protected)/progress/math/page.tsx
"use client"
...
export default function MathProgressPage() {
  ...
  }, [rows, categoryFilter, timeFilter])
      ...
      <div style={{ maxWidth: "1320px", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            >
              Explore performance across all seven maths categories with live filters,
              trend tracking, and category-by-category insights.
            </p>
          </div>
        ...
        >
          ...
          <SectionCard
            ...
            subtitle="See which areas have been practised the most."
          >
            <div style={{ width: "100%", height: "340px" }}>
              {attemptsByCategoryData.length ? (
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={attemptsByCategoryData}>
                    <CartesianGrid strokeDasharray="3 3" />
                    <XAxis dataKey="category" tick={{ fontSize: 11 }} interval={0} angle={-12} textAnchor="end" height={70} />
                    <YAxis allowDecimals={false} />
                    <Tooltip />
                    <Bar dataKey="attempts" fill="#8b5cf6" radius={[10, 10, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              ) : (
                <div
