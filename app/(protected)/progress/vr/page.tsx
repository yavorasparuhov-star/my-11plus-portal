...
export default function VRProgressPage() {
  const [progress, setProgress] = useState<VRProgressRow[]>([])
  ...
  if (loading) {
    return <p style={styles.message}>Loading VR progress...</p>
  }

  return (
    <div style={styles.page}>
      <div style={styles.container}>
        <h1 style={styles.title}>🧠 Verbal Reasoning Progress</h1>
        <p style={styles.subtitle}>
          Track verbal reasoning test performance over time.
        </p>
        ...
        {progress.length === 0 ? (
          <div style={styles.emptyCard}>
            <h2>No VR progress yet</h2>
            <p>Complete a verbal reasoning test and your results will appear here.</p>
          </div>
        ) : (
        ...
        <div style={styles.summaryCard}>
          ...
          <p>
            You answered <strong>{totalCorrectAnswers}</strong> VR questions
