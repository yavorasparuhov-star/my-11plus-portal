    ...
    <>
      ...
      <div style={pageStyle}>
        <div style={containerStyle}>
          <h1 style={titleStyle}>Algebra & Reasoning</h1>

          <p style={textStyle}>
            Develop algebraic thinking, simple formula work, sequences, and
            logical reasoning through 11+ style problem solving.
          </p>
