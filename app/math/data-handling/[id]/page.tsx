...
const TIMER_STORAGE_KEY = "math_data_handling_timer_enabled"

export default function DataHandlingTestPage() {
  ...
  if (loading) {
    return (
      <>
        <Header />
        <p style={styles.message}>Loading Data Handling test...</p>
      </>
    )
  }
        ...
        <div style={styles.page}>
          <div style={styles.container}>
            <div style={styles.heroCard}>
              <h1 style={styles.title}>📊 Data Handling Test Complete</h1>
            ...
            <div style={styles.resultBanner}>
              ...
              <div style={styles.resultBox}>
                ...
                <p style={styles.resultText}>
                  <strong>Category:</strong> Data Handling
                </p>
