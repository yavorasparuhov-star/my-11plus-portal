  ...
  useEffect(() => {
    async function loadPage() {
      ...
      if (testError) {
        ...
        setErrorMessage("Could not load this Number & Place Value test.")
        setLoading(false)
        return
      }
  ...
  async function submitResults(finalAnswers: UserAnswerMap) {
    ...
    try {
      ...
      if (latestResultError) {
        ...
        console.log("Latest Number & Place Value result saved:", savedLatestResult)
      }
    ...
    return (
      <>
        ...
        <div style={styles.page}>
          <p style={styles.message}>Loading Number & Place Value test...</p>
        </div>
      </>
    )
  }
        ...
        <div style={styles.page}>
          <div style={styles.container}>
            <div style={styles.heroCard}>
              <h1 style={styles.title}>🔢 Number & Place Value Test Complete</h1>
