  ...
  useEffect(() => {
    async function loadPage() {
      ...
      if (testError) {
        ...
        setErrorMessage("Could not load this Measurement test.")
        setLoading(false)
        return
      }
  ...
  async function handleTimeUp() {
    ...
    try {
      ...
      if (latestResultError) {
        ...
        console.log("Latest Measurement result saved:", savedLatestResult)
      }
    ...
    return (
      <>
        ...
        <div style={styles.page}>
          <p style={styles.message}>Loading Measurement test...</p>
        </div>
      </>
    )
  }
        ...
        <div style={styles.page}>
          <div style={styles.container}>
            <div style={styles.heroCard}>
              <h1 style={styles.title}>📏 Measurement Test Complete</h1>
            ...
            <div style={styles.resultBanner}>
              ...
              <div style={styles.resultBox}>
                ...
                <p style={styles.resultText}>
                  <strong>Category:</strong> Measurement
                </p>
