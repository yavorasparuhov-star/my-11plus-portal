...
const TIMER_STORAGE_KEY = "sentence_punctuation_timer_enabled"
...
export default function SentencePunctuationTestPage() {
  ...
  async function saveLatestTestResult(
    ...
    console.error("Error upserting latest sentence punctuation result:", {
    ...
    if (deleteError) {
      console.error("Error deleting old sentence punctuation result:", {
    ...
    if (insertError) {
      console.error("Error saving latest sentence punctuation result:", {
