...
const RESULT_CATEGORY = "sentence"
...
function SentencePunctuationContent() {
  ...
  async function fetchTests() {
    ...
    if (testsError) {
      console.error("Error loading sentence punctuation tests:", testsError)
      setLoading(false)
      return
    }
    ...
    if (mode === "review") {
      ...
      if (reviewQuestionsError) {
        console.error(
          "Error loading sentence punctuation review questions:",
    ...
    if (progressError) {
      console.error("Error loading sentence punctuation progress:", progressError)
      ...
      <>
        ...
        <p style={styles.message}>
          {mode === "review"
            ...
            : "Loading Sentence Punctuation tests..."}
        </p>
      </>
    )
  }
        ...
        <div style={styles.container}>
          <div style={styles.heroCard}>
            ...
            <p style={styles.subtitle}>
              {mode === "review"
                ? "Revise your saved punctuation mistakes and strengthen sentence punctuation skills."
                : "Choose a Sentence Punctuation test and answer 10 multiple-choice questions."}
            </p>
            ...
            <div style={styles.accessInfo}>
              {plan === "guest"
                ...
                : plan === "free"
                  ...
                  : "Your membership unlocks all Sentence Punctuation tests."}
            </div>
          ...
          {tests.length === 0 ? (
            <div style={styles.emptyCard}>
              <h2>
                {mode === "review"
                  ? "No Sentence Punctuation review items found"
                  : "No Sentence Punctuation tests yet"}
              </h2>
              ...
              {filteredTests.length === 0 ? (
                ...
                <div style={styles.grid}>
                  {filteredTests.map((test) => {
                    const href =
                      mode === "review"
                        ? `/english/punctuation/sentence/${test.id}?mode=review`
                        : `/english/punctuation/sentence/${test.id}`
                      ...
                      >
                        ...
                        <p style={styles.preview}>
                          {test.description?.trim()
                            ? test.description
                            : "Practise full stops, capital letters, question marks, exclamation marks, and correct punctuation across whole sentences in this test."}
                        </p>
