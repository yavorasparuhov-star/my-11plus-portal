...
const TIMER_STORAGE_KEY = "apostrophes_timer_enabled"
...
export default function ApostrophesTestPage() {
  ...
  useEffect(() => {
    async function loadPage() {
      ...
      const loadedTest = testData as ApostrophesTest
      setTest(loadedTest)
  ...
  async function saveLatestTestResult(
    ...
    console.error("Error upserting latest apostrophes result:", {
    ...
    if (deleteError) {
      console.error("Error deleting old apostrophes result:", {
    ...
    if (insertError) {
      console.error("Error saving latest apostrophes result:", {
  ...
  async function submitResults(finalAnswers: UserAnswerMap) {
    ...
    if (correctlyAnsweredReviewQuestionIds.length > 0) {
      ...
      if (deleteReviewError) {
        console.error(
          "Error removing correctly answered apostrophes review items:",
          {
          ...
          <div style={styles.container}>
            <div style={styles.heroCard}>
              <h1 style={styles.title}>
                {mode === "review" ? "📝 Review Complete" : "📝 Apostrophes Test Complete"}
              </h1>
            ...
            <div style={styles.resultBanner}>
              ...
              <div style={styles.resultBox}>
                ...
                <p style={styles.resultText}>
                  <strong>Category:</strong> Apostrophes
                </p>
