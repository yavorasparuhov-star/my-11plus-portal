  ...
  return (
    <Suspense
      fallback={
        <>
          <Header />
          <p style={styles.message}>Loading Advanced Punctuation tests...</p>
        </>
      }
    >
      <AdvancedPunctuationContent />
    </Suspense>
  )
}

function AdvancedPunctuationContent() {
            ...
            <div style={styles.accessInfo}>
              {plan === "guest"
                ...
                : plan === "free"
                  ...
                  : "Your membership unlocks all Advanced Punctuation tests."}
            </div>
