...
type PunctuationAdvancedPunctuationTest = {
  id: number
  title: string
...
type PunctuationAdvancedPunctuationQuestion = {
  id: number
  test_id: number
}

type PunctuationAdvancedPunctuationProgress = {
  id: string
  user_id: string
  test_id: number | null
...
type TestWithProgress = PunctuationAdvancedPunctuationTest & {
  score: number
...
export default function AdvancedPunctuationPage() {
  ...
  async function fetchTests() {
    ...
    if (testsError) {
      console.error("Error loading advanced punctuation tests:", testsError)
      setLoading(false)
      return
    }

    let allTests = (testsData || []) as PunctuationAdvancedPunctuationTest[]
    ...
    if (mode === "review") {
      ...
      if (reviewQuestionsError) {
        console.error(
          "Error loading advanced punctuation review questions:",
      ...
      const reviewQuestions =
        (reviewQuestionsData || []) as PunctuationAdvancedPunctuationQuestion[]
    ...
    if (progressError) {
      console.error("Error loading advanced punctuation progress:", progressError)
    ...
    const progressRows = (progressData || []) as PunctuationAdvancedPunctuationProgress[]
    const latestProgressMap = new Map<number, PunctuationAdvancedPunctuationProgress>()
      ...
      <>
        ...
        <p style={styles.message}>
          {mode === "review"
            ...
            : "Loading Advanced Punctuation tests..."}
        </p>
      </>
    )
  }
          ...
          <div style={styles.heroCard}>
            ...
            <p style={styles.subtitle}>
              {mode === "review"
                ...
                : "Choose an Advanced Punctuation test and answer 10 multiple-choice questions."}
            </p>
              ...
              {filteredTests.length === 0 ? (
                ...
                <div style={styles.grid}>
                  {filteredTests.map((test) => {
                    const href =
                      mode === "review"
                        ? `/english/punctuation/advanced-punctuation/${test.id}?mode=review`
                        : `/english/punctuation/advanced-punctuation/${test.id}`
                      ...
                      >
                        ...
                        <p style={styles.preview}>
                          {test.description?.trim()
                            ? test.description
                            : "Practise semicolons, colons, dashes, brackets, hyphens, and other advanced punctuation features in this test."}
                        </p>
