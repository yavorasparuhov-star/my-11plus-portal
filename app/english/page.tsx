      ...
      <div style={styles.page}>
        <div style={styles.hero}>
          ...
          <p style={styles.subtitle}>
            Choose an English training activity and keep building vocabulary,
        ...
        <div style={styles.grid}>
          ...
          >
            ...
            <p style={styles.cardText}>
              Strengthen word knowledge, meanings, and usage with multiple-choice
              practice.
            </p>
          ...
          >
            ...
            <p style={styles.cardText}>
              Read passages carefully and answer questions to build understanding and
              accuracy.
            </p>
              ...
              <div style={styles.statRow}>
                ...
                <span
                  style={{
                    ...styles.scoreBadge,
                    ...getScoreBadgeStyle(
                      loadingStats ? null : stats.comprehensionScore
                    ),
                  }}
                >
                  {loadingStats
                    ? "Loading..."
                    : getScoreLabel(stats.comprehensionScore)}
                </span>
              </div>
