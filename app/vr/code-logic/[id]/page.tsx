...
export default function VRCodesLogicTestPage() {
  ...
  async function submitResults(finalAnswers: UserAnswerMap) {
    ...
    try {
      ...
      if (latestResultError) {
        ...
        console.log("Latest VR Codes & Logic result saved:", savedLatestResult)
  ...
  if (loading) {
    return (
      <>
        <Header />
        <p style={styles.message}>Loading Codes & Logic test...</p>
      </>
    )
  }
          ...
          <div style={styles.container}>
            <div style={styles.emptyCard}>
              ...
              <p style={styles.subtitle}>
                This Codes & Logic test is not available yet.
              </p>
        ...
        <div style={styles.page}>
          <div style={styles.container}>
            <div style={styles.heroCard}>
              <h1 style={styles.title}>🧠 Codes & Logic Test Complete</h1>
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.resultBox}>
                ...
                <p style={styles.resultText}>
                  <strong>Category:</strong> Codes & Logic
                </p>
